		    	...
		    	<div class='card'>
				    ...
				    <div class='card-body'>
				        ...
				        <form method="post" action="${pageContext.request.contextPath}/tavolo/list" class="row g-3">
							...
							<div class="col-md-6">	
								<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date' value='${search_tavolo_attr.dateCreated}' />
							...
							<div class="col-md-6">
								<label for="cifraMin" class="form-label">Puntata minima</label>
