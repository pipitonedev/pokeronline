	...
	<body class="d-flex flex-column h-100">
		...
		<main class="flex-shrink-0">
			<div class="container">
					...
					<spring:hasBindErrors  name="tavolo_creatore_attr">
						<%-- alert errori --%>
								...
								<form:form method="post" modelAttribute="insert_tavolo_attr" action="save" novalidate="novalidate" class="row g-3">
									...
									<div class="col-md-6">
										...
										<spring:bind path="denominazione">
											<input type="text" name="denominazione" id="denominazione" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire denominazione" value="${insert_tavolo_attr.denominazione }">
										</spring:bind>
									...
									<div class="col-md-6">
										...
										<spring:bind path="esperienzaMin">
											<input type="number" class="form-control ${status.error ? 'is-invalid' : ''}" name="esperienzaMin" id="esperienzaMin" placeholder="Inserire esperienza minima" value="${insert_tavolo_attr.esperienzaMin }">
										</spring:bind>
									...
									<div class="col-md-6">
										...
										<spring:bind path="cifraMin">
											<input type="number" class="form-control ${status.error ? 'is-invalid' : ''}" name="cifraMin" id="cifraMin" placeholder="Inserire la cifra minima" value="${insert_tavolo_attr.cifraMin }">
										</spring:bind>
